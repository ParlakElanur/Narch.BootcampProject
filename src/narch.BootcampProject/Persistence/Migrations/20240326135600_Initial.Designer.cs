...
namespace Persistence.Migrations
{
    ...
    [Migration("20240326135600_Initial")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5c27e4bc-2f88-4de2-a853-ac7af543e548"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(1996, 10, 28, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            FirstName = "Elanur",
                            LastName = "Parlak",
                            PasswordHash = new byte[] { 200, 47, 155, 199, 135, 79, 123, 151, 37, 77, 14, 90, 41, 197, 171, 52, 218, 170, 50, 122, 244, 33, 82, 92, 71, 30, 137, 28, 31, 138, 127, 10, 166, 152, 22, 114, 124, 56, 100, 12, 40, 135, 158, 233, 244, 7, 132, 77, 131, 246, 127, 86, 85, 132, 145, 9, 178, 117, 89, 41, 149, 135, 87, 244 },
                            PasswordSalt = new byte[] { 111, 103, 103, 98, 42, 220, 223, 227, 124, 217, 19, 138, 78, 123, 137, 145, 4, 91, 235, 134, 212, 202, 141, 91, 207, 180, 198, 246, 130, 41, 146, 114, 127, 145, 223, 0, 99, 132, 134, 230, 187, 185, 121, 107, 190, 168, 29, 90, 12, 154, 69, 95, 232, 24, 130, 224, 50, 116, 243, 160, 53, 168, 155, 46, 148, 132, 47, 249, 184, 206, 157, 58, 179, 84, 172, 226, 145, 175, 110, 213, 54, 212, 62, 129, 116, 5, 243, 186, 174, 29, 240, 110, 72, 139, 154, 68, 153, 232, 220, 45, 214, 245, 150, 77, 242, 250, 43, 88, 123, 4, 165, 132, 47, 14, 135, 208, 40, 65, 86, 193, 95, 6, 224, 231, 132, 197, 65, 223 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1834016e-2ef8-49f6-8fd9-e8b7f1c50f27"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("5c27e4bc-2f88-4de2-a853-ac7af543e548")
                        });
                });
