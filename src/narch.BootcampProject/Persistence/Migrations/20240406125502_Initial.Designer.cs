...
namespace Persistence.Migrations
{
    ...
    [Migration("20240406125502_Initial")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6b3323d5-9335-4e7e-8253-fdc46c30015f"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            FirstName = "Elanur",
                            LastName = "Parlak",
                            PasswordHash = new byte[] { 89, 247, 45, 167, 126, 142, 95, 49, 173, 153, 219, 48, 218, 48, 250, 191, 96, 239, 110, 248, 242, 41, 55, 81, 40, 232, 47, 243, 156, 23, 90, 63, 8, 39, 240, 234, 230, 79, 216, 208, 140, 241, 11, 107, 57, 33, 213, 108, 237, 251, 176, 19, 120, 143, 142, 125, 135, 101, 178, 83, 247, 92, 186, 92 },
                            PasswordSalt = new byte[] { 191, 230, 239, 227, 232, 73, 102, 215, 211, 24, 94, 57, 207, 90, 129, 182, 224, 119, 121, 247, 15, 99, 8, 203, 213, 145, 36, 229, 95, 92, 153, 219, 235, 250, 182, 251, 74, 101, 214, 70, 147, 233, 131, 145, 189, 135, 197, 24, 168, 214, 7, 245, 25, 193, 61, 223, 19, 16, 42, 191, 72, 165, 114, 65, 181, 197, 89, 89, 245, 219, 78, 230, 220, 241, 208, 1, 118, 225, 221, 166, 233, 118, 173, 126, 34, 127, 228, 167, 52, 32, 190, 158, 171, 73, 175, 101, 166, 85, 208, 84, 53, 121, 244, 246, 182, 253, 237, 108, 22, 82, 113, 85, 64, 54, 164, 247, 97, 202, 204, 121, 195, 233, 221, 220, 104, 159, 64, 135 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e5e085aa-a90b-45f0-ae53-eb40486b34d5"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("6b3323d5-9335-4e7e-8253-fdc46c30015f")
                        });
                });
